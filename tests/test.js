...
const TestSuite = {
    ...
    testHelpers() {
        ...
        console.assert(typeof generateRandomPaymentAmount === 'function', 'generateRandomPaymentAmount exists');
    ...
    testExtendedOptions() {
        ...
        console.assert(window.extendedOptions.hasOwnProperty('redirectUrl'), 'Extended options has redirectUrl');
        console.groupEnd();
    },
